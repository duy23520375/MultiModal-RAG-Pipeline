...
Hệ thống RAG (Retrieval-Augmented Generation) đa phương tiện tiên tiến, cho phép người dùng trò chuyện với tài liệu PDF phức tạp bao gồm văn bản, bảng biểu và hình ảnh. Sử dụng kiến trúc Hybrid Search kết hợp với Reranking để đạt độ chính xác tối ưu.
...
- **Reranking SOTA**: Sử dụng **Cohere Rerank** (`rerank-multilingual-v3.0`) để tái sắp xếp kết quả, đảm bảo thông tin chính xác nhất được đưa vào Context.
